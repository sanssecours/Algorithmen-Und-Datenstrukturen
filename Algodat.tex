...
\setitalicmainfont[Mapping=tex-text]{Menlo}
...
\newcommand{\SUBJECT}{Diverse in Unterlagen zur LVA Algorithmen und Datenstrukturen}
\newcommand{\LOCATION}{Wien}
\newcommand{\KEYWORDS}{Dynamische Programmierung, Algorithmen und Datenstrukturen 1, Matrix, Laufzeitbestimmung}
...
\definecolor{aqua}{rgb}{0,0.56,1.0}
\titleformat{\section}{\sffamily\bfseries}{}{0pt}{\large}[{\color{aqua}\hrule}]
...
\begin{table}[H]
	\begin{center}
		\begin{tabular}{l|cccccccc}
			...
			6 & 7\\
			\hline
			Keine Sorte			& {\color{orange}0} & 0 & 0 & 0	 &	0 &	 0 & 0 & 
			0	 \\
			\textbf{Creme de la Creme}	& 0 &	&	& {\color{orange}10} &	  &	   
			&	&	 \\
			Brokkoli			& 0 & 3 &	& {\color{orange}10} & 13 &	   &	
			&	 \\
			\textbf{Vanille}				& 0 & 3 & 7 & 10 & 13 & 
			{\color{orange}17} & 20 &	 \\
			\textbf{Málaga}				& 0 & 3 & 8 & 11 & 15 & 18 & 21 & 
			{\color{orange}25} \\
			Schokolade			& 0 & 3 & 8 & 11 & 15 & 18 & 21 & 
			{\color{orange}\emph{25}} \\
		\end{tabular}
	\end{center}
